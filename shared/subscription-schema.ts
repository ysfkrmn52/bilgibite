...
export const DEFAULT_PLANS: InsertSubscriptionPlan[] = [
  {
    ...
    name: 'Temel (Ücretsiz)',
    nameEn: 'Basic (Free)',
    description: '5 günlük quiz, temel özellikler, reklamlar',
    descriptionEn: '5 daily quizzes, basic features, ads',
    price: '0.00',
    currency: 'TRY',
  ...
  },
  {
    ...
    description: 'Sınırsız quiz, AI öğretmen, gelişmiş analiz, reklamız deneyim',
    descriptionEn: 'Unlimited quizzes, AI tutor, advanced analytics, ad-free',
    price: '49.99',
    currency: 'TRY',
    billingPeriod: 'monthly',
    maxUsers: 1,
  ...
  },
  {
    ...
    description: 'Premium özelliklerin hepsi, %40 indirimli yıllık ödeme',
    descriptionEn: 'All premium features, 40% discount with yearly billing',
    price: '299.99',
    currency: 'TRY',
  ...
  },
  {
    ...
    name: 'Aile Planı',
    nameEn: 'Family Plan',
    description: '6 kullanıcıya kadar, tüm premium özellikler, aile yönetimi',
    descriptionEn: 'Up to 6 users, all premium features, family management',
    price: '79.99',
    currency: 'TRY',
    billingPeriod: 'monthly',
    maxUsers: 6,
  ...
  },
  {
    ...
    description: 'Öğrenci doğrulaması ile %50 indirimli premium özellikler',
    descriptionEn: '50% discount on premium features with student verification',
    price: '24.99',
    currency: 'TRY',
    billingPeriod: 'monthly',
    maxUsers: 1,
